...
const Footer = () => {
    return (
        <Box component="footer" sx={{ position: 'relative', zIndex: 1300, bgcolor: '#060a12', color: 'text.secondary', py: 8, borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            <Container maxWidth="lg">
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        ...
                        <Link component={RouterLink} to="/about" sx={{ color: 'inherit', display: 'block', mb: 1, textDecoration: 'none', transition: 'color 0.2s', '&:hover': { color: '#3b82f6' } }}>
                            About
                        </Link>
                        <Link component={RouterLink} to="/contact" sx={{ color: 'inherit', display: 'block', mb: 1, textDecoration: 'none', transition: 'color 0.2s', '&:hover': { color: '#3b82f6' } }}>
                            Contact
                        </Link>
